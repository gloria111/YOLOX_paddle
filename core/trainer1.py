...
paddle.set_printoptions(threshold=20)
...
class Trainer:
    ...
    def before_train(self):
        ...
        # model related init
        paddle.set_device('gpu:%d' % self.local_rank)
    ...
    def resume_train(self, model):
        if self.args.resume:
            ...
            if self.args.ckpt is None:
                ckpt_file = os.path.join(self.file_name, "latest" + "_ckpt.pdiparams")
            else:
