...
import sys
sys.path.append('/home/aistudio/paddle版本/YOLOX/yolox/utils/')
import numpy as np
...
def postprocess(prediction, num_classes, conf_thre=0.7, nms_thre=0.45, class_agnostic=False):
    ...
    for i, image_pred in enumerate(prediction):
        ...
        conf_mask = paddle.concat([mask,mask,mask,mask,mask,mask,mask], axis=1)
        ...
        #参数：boxes: Tensor, 预测框scores: Tensor, 预测置信度iou_threshold: float, IOU阈值
